...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \begin{longtabu} to \textwidth {| X[1,l] | X[2,l] |}
	    ...
	    \\ \hline
	    \multicolumn{2}{|c|}{\textbf{Process Management}}
	    \\ \hline
	    pid = fork()
	    &
		...
		\\ \hline
		\multicolumn{2}{|c|}{\textbf{File Management}}
	    \\ \hline
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Ready processes (purple) and a running process (green).}
  \end{minipage}}
\end{figure}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Blocked processes (red), ready processes (purple) and a running process (green).}
  \end{minipage}}
\end{figure}
...
\begin{longtabu} to \textwidth {|X[1,l]|X[1,l]|}
    ...
    \textbf{Prevents other processes from starting} while another is in progress and therefore, if processes are of varying sizes, there may be inefficiencies since a single process may take a long time to complete therefore leaving the user waiting before they can perform any other actions.
	\\ \hline
	\multicolumn{2}{|p{\textwidth}|}{\textbf{Favours short processes} as the processes with the shortest estimated time are given the opportunity to run until completion and therefore, some longer processes may not be able to start processing until there are no more shorter processes currently running or ready to be processed.}
	\\ \hline
\end{longtabu}
...
\begin{longtabu} to \textwidth {|X[1,l]|X[1,l]|}
	...
	\\ \hline
	\multicolumn{2}{|p{\textwidth}|}{\textbf{Favours short processes} as the processes with the shortest estimated time are given the opportunity to run until a process with a shorter estimated time is ready and therefore, some longer processes may not be able to start processing until there are no more shorter processes currently running or ready to be processed.}
	\\ \hline
\end{longtabu}
...
\begin{longtabu} to \textwidth {|X[1,l]|X[1,l]|}
    ...
    \textbf{Advantages} & \textbf{Disadvantages}
    \\ \hline
    \textbf{High priority processes are processed quickly} because they take precedence.
    &
    \textbf{Relies on an estimation} of the priority of a process which could be incorrect.
	\\ \hline
\end{longtabu}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \begin{longtabu} to \textwidth {|X[0.8,c]|X[2,l]|X[2,l]|}
		...
		& When running multiple processes concurrently, they share resources, such as memory, disk and printers.
		\\ \hline
	\end{longtabu}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{7cm}]{images/chapter-3/user-threads.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{7cm}]{images/chapter-3/kernel-threads.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{7cm}]{images/chapter-5/cache-memory.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{10cm}]{images/chapter-5/referencing-physical-memory.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{5cm}]{images/chapter-5/fixed-partitioned-memory.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{5cm}]{images/chapter-5/variable-partitioned-memory.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Variable partitioned memory.}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{7cm}]{images/chapter-5/varying-process-sizes.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \begin{longtabu} to \textwidth {|X[0.5,l]|X[0.75,l]|X[0.75,l]|X[2,l]|}
	    ...
	    \\ \hline
		\texttt{Class 0} & 0 & 0 & Not referenced and not modified.
		\\ \hline
...
The \textbf{clock page replacement algorithm} is also a variation of the FIFO page replacement algorithm and is similar to the second chance page replacement algorithm but maintains the pages on a circular list.
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \centering
    \includegraphics[max size={\textwidth}{4cm}]{images/chapter-8/file-descriptor-table-fixed-size-entries.png}
  \end{minipage}}
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
...
\begin{longtabu} to \textwidth {|X[0.85,c]|X[2,l]|X[2,l]|}
	...
	\\ \hline
	\multirow{1}{*}{\shortstack[l]{Implementing \\ \texttt{Runnable}}}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{5cm}]{images/chapter-18/ipv4-address.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{longtabu} to \textwidth {| X[1,l] | X[0.5,l] | X[2,l] |}
	...
	\\ \hline
	11100010.23.14.45 & Invalid. & Mixes binary and dotted-decimal notation.
	\\ \hline
	221.34.5.6.70 & Invalid. & There can be no more than four blocks of numbers.
	\\ \hline
	111.56.041.76 & Invalid. & There can be no leading zero in any of the blocks.
	\\ \hline
	75.45.301.14 & Invalid. & All blocks must be in the range 0 to 255 (0 to $2^{8}-1$).
	\\ \hline
	240.65.75.0 & Valid. & Conforms to all of the representation standards.
	\\ \hline
\end{longtabu}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/ipv4-classes.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\begin{equation*}
				\begin{aligned}
					& \text{00000001 00001011 00001011 11101111} \\
					& \text{starts with a 0} \\
					& \therefore \text{00000001 00001011 00001011 11101111 has class A} \\
					& \text{Network ID contained in the first byte} \\
					& \therefore \text{Network ID} = 00000001 = 1 \\
					& \text{Host ID contained in the last three bytes} \\
					& \therefore \text{Host ID} = 00001011 00001011 11101111 = 11.11.239 \\
				\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of a class from an IPv4 address.}
	\end{minipage}}
\end{figure}
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\begin{equation*}
				\begin{aligned}
					& \text{11000001 10000011 00011011 11111111} \\
					& \text{starts with 110} \\
					& \therefore \text{11000001 10000011 00011011 11111111 has class C} \\
					& \text{Network ID contained in the first three bytes} \\
					& \therefore \text{Network ID} = 11000001 10000011 00011011 = 193.131.27 \\
					& \text{Host ID contained in the fourth byte} \\
					& \therefore \text{Host ID} = 11111111 = 255 \\
				\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\begin{equation*}
				\begin{aligned}
					...
					& \text{120} = 01111000 \\
					& \text{8} = 00001000 \\
					& \therefore \text{14.23.120.8} = \text{00001110 00010111 01111000 00001000} \\
					& \text{starts with 0} \\
					& \therefore \text{14.23.120.8 has class A} \\
					& \text{Network ID contained the first byte} \\
					& \therefore \text{Network ID} = 00001110 = 14 \\
					& \text{Host ID contained in the last three bytes} \\
					& \therefore \text{Host ID} = 00010111 01111000 00001000 = 23.120.8 \\
				\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\begin{equation*}
				\begin{aligned}
					...
					& \text{15} = 00001111 \\
					& \text{111} = 01101111 \\
					& \therefore \text{252.5.15.111} = \text{11111100 00000101 00001111 01101111} \\
					& \text{starts with 1111} \\
					& \therefore \text{252.5.15.111 has class E} \\
				\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
...
\label{special_addresses}

\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/ipv4-special-addresses.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{IPv4 special addresses.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/ipv4-header.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{7cm}]{images/chapter-18/ip-fragmentation.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{IP fragmentation.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{5cm}]{images/chapter-18/ipv6-address.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/ipv6-header.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{An IPv6 header.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/internet-routing.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Internet routing.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-18/tunneling.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example of tunneling.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-19/ipv4-classes.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{IPv4 classes.}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-19/subnet-mask.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Subnet mask.}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		...
		starts with a 0 \\
		$\therefore$ 00000001 00001011 00001011 11101111 has class \texttt{A} \\
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnet mask = 255.0.0.0 \\
			& subnet mask = 11111111 00000000 00000000 00000000 \\
		\end{longtabu}
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Network ID & = & & 00000001 00001011 00001011 11101111
			\\
		...
		\end{longtabu}
		network ID = 00000001 00000000 00000000 00000000 \\
		network ID = 1
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Host ID & = & & 00000001 00001011 00001011 11101111
			\\
			&   & \& & 00000000 11111111 11111111 11111111
			\\
			& & & -------------------------------------------------------
			\\
			&   & = & 00000000 00001011 00001011 11101111
		\end{longtabu}
		host ID = 00000000 00001011 00001011 11101111 \\
		host ID = 11.11.239 \\
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of network ID and host ID from a class \texttt{A} IP address using subnet masks.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		10001001 10000010 00001011 11001111 \\
		starts with 10 \\
		$\therefore$ 10001001 10000010 00001011 11001111 has class \texttt{B} \\
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnet mask = 255.255.0.0 \\
			& subnet mask = 11111111 11111111 00000000 00000000 \\
		\end{longtabu}
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Network ID & = & & 10001001 10000010 00001011 11001111
			\\
			&   & \& & 11111111 11111111 00000000 00000000
			\\
			& & & -------------------------------------------------------
			\\
			&   & = & 10001001 10000010 00000000 00000000
		\end{longtabu}
		network ID = 10001001 10000010 00000000 00000000 \\
		network ID = 137.130
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Host ID & = & & 10001001 10000010 00001011 11001111
			\\
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of network ID and host ID from a class \texttt{B} IP address using subnet masks.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		...
		starts with 110 \\
		$\therefore$ 11000001 10000011 00011011 11111111 has class \texttt{C} \\
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnet mask = 255.255.255.0 \\
			& subnet mask = 11111111 11111111 11111111 00000000 \\
		\end{longtabu}
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Network ID & = & & 11000001 10000011 00011011 11111111
			\\
			&   & \& & 11111111 11111111 11111111 00000000
			\\
			& & & -------------------------------------------------------
			\\
			&   & = & 11000001 10000011 00011011 00000000
		\end{longtabu}
		network ID = 11000001 10000011 00011011 00000000 \\
		network ID = 193.131.27
		\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			Host ID & = & & 11000001 10000011 00011011 11111111
			\\
			...
			&   & = & 00000000 00000000 00000000 11111111
		\end{longtabu}
		host ID = 00000000 00000000 00000000 11111111 \\
		host ID = 255 \\
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of network ID and host ID from a class \texttt{C} IP address using subnet masks.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-19/subnetting.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Subnetting for class \texttt{B}.}
	\end{minipage}}
\end{figure}
...
When using the original default subnet masks in addressing with classes, it is easy to identify the network address because it is fixed, as shown in the examples below.

\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		128.208.0.0/16 \\
		$\therefore$ 16 bits are used for the network prefix \\
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnet mask = 11111111 11111111 00000000 00000000 \\
			& subnet mask = 255.255.0.0 \\
		\end{longtabu}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of subnet mask from a class \texttt{B} IP address using original default subnet masks.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		198.208.80.0/24 \\
		$\therefore$ 24 bits are used for the network prefix \\
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnet mask = 11111111 11111111 11111111 0000000 \\
			& subnet mask = 255.255.255.0 \\
		\end{longtabu}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of subnet mask from a class \texttt{C} IP address using original default subnet masks.}
	\end{minipage}}
\end{figure}

However, when using the extended network prefix in classless addressing, groups in the binary (8-bit) representations of the subnet masks may have mixed zero's (\texttt{}'s) and one's (\texttt{1}'s), as shown in the examples below.

\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\textwidth-2\fboxsep-2\fboxrule}
		\textbf{given that the IP address 131.46.56.0 is class B} \\
		$\therefore$ subnet mask = 255.255.0.0 \\
		$\therefore$ 16 bits are used for the network prefix \\
		$\therefore$ CIDR = 131.45.56.0/16 \\
		\vspace{5mm}
		\hrule
		\vspace{1mm}
		\textbf{given now that the subnet mask is 255.255.128.0, determine the CIDR} \\
		255.255.128.0 = 11111111 11111111 10000000 00000000 \\
		$\therefore$ 17 bits are used for the extended network prefix \\
		$\therefore$ CIDR = 131.46.56.0/17 \\
		\begin{longtabu} to \textwidth {X[0.3,l] X[0.1,l] X[0.1,l] X[3,l]}
			\multicolumn{4}{l}{subnets available = $2^{X - Y}$} \\
			where & X & = & the number of bits in extended network prefix, \\
			& Y & = & the number of bits in network prefix in default subnet mask.
		\end{longtabu}
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnets available = $2^{17-16}$ \\
			& subnets available = $2^{1}$ \\
			& subnets available = 2 \\
		\end{longtabu}
		\vspace{5mm}
		\hrule
		\vspace{1mm}
		\textbf{given now that the subnet mask is 255.255.248.0, determine the CIDR} \\
		255.255.248.0 = 11111111 11111111 11111000 00000000 \\
		$\therefore$ 21 bits are used for the extended network prefix \\
		$\therefore$ CIDR = 131.46.56.0/21 \\
		\begin{longtabu} to \textwidth {X[0.3,l] X[0.1,l] X[0.1,l] X[3,l]}
			\multicolumn{4}{l}{subnets available = $2^{X - Y}$} \\
			where & X & = & the number of bits in extended network prefix, \\
			& Y & = & the number of bits in network prefix in default subnet mask.
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of subnet mask from a class \texttt{B} IP address using the extended network prefix.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\textwidth-2\fboxsep-2\fboxrule}
		\textbf{given that the IP address 192.168.128.0 is class C} \\
		$\therefore$ subnet mask = 255.255.255.0 \\
		$\therefore$ 24 bits are used for the network prefix \\
		$\therefore$ CIDR = 192.168.128.0/24 \\
		\vspace{5mm}
		\hrule
		\vspace{1mm}
		\textbf{given now that the subnet mask is 255.255.255.192, determine the CIDR} \\
		255.255.255.192 = 11111111 11111111 11111111 11000000 \\
		$\therefore$ 26 bits are used for the extended network prefix \\
		$\therefore$ CIDR = 192.168.128.0/26 \\
		\begin{longtabu} to \textwidth {X[0.3,l] X[0.1,l] X[0.1,l] X[3,l]}
			\multicolumn{4}{l}{subnets available = $2^{X - Y}$} \\
			where & X & = & the number of bits in extended network prefix, \\
			& Y & = & the number of bits in network prefix in default subnet mask.
		\end{longtabu}
		\begin{longtabu} to \textwidth {X[0.1,l] X[6,l]}
			$\therefore$ & subnets available = $2^{26-24}$ \\
			& subnets available = $2^{2}$ \\
			& subnets available = 4 \\
		\end{longtabu}
		\vspace{5mm}
		\hrule
		\vspace{1mm}
		\textbf{given now that the subnet mask is 255.255.255.224, determine the CIDR} \\
		255.255.255.224 = 11111111 11111111 11111111 11100000 \\
		$\therefore$ 27 bits are used for the extended network prefix \\
		$\therefore$ CIDR = 192.168.128.0/27 \\
		\begin{longtabu} to \textwidth {X[0.3,l] X[0.1,l] X[0.1,l] X[3,l]}
			\multicolumn{4}{l}{subnets available = $2^{X - Y}$} \\
			where & X & = & the number of bits in extended network prefix, \\
			& Y & = & the number of bits in network prefix in default subnet mask.
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example determination of subnet mask from a class \texttt{C} IP address using the extended network prefix.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-19/subnetting-example.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example of subnetting.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	\lineskip=-\fboxrule
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		A packet arrives with the destination address 128.208.2.130.
		
		\begin{center}
			$\downarrow$
		\end{center}
		
		It is determined that the subnet mask is 255.255.196.0 for all subnets.
		
		\begin{center}
			$\downarrow$
		\end{center}
	
		The destination address is bitwise \texttt{AND}ed with the subnet mask to determine the subnet:
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example process for routing a packet to a subnet using CLSM.}
	\end{minipage}}
\end{figure}

In this example:
\begin{itemize}
	\item the total number of allocated addresses is 65536;
	\item the number of allocated addresses to each department is as follows \dots{}
	\begin{itemize}
		\item[--] Computer Science department (CS) -- 16384 (with extended prefix /18);
		\item[--] Engineering department (EE) -- 16384 (with extended prefix /18); and
		\item[--] Art department (Art) -- 16384 (with extended prefix /18).
	\end{itemize}
	\item the total number of unallocated (available) addresses is 16384.
\end{itemize}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			...
			\begin{itemize}
				\item the subnet mask is 255.255.128.0 for the Computer Science department (CS);
				\item the subnet mask is 255.255.196.0 for the Engineering department (EE); and
				\item the subnet mask is 255.255.244.0 for the Art department (Art).
			\end{itemize}
			...
			The destination address is bitwise \texttt{AND}ed with the each subnet mask individually to determine the subnet.
			
			\begin{center}
				$\downarrow$
			\end{center}
			
			For the Computer Science department (CS):
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Example process for routing a packet to a subnet using VLSM.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/physical-transmission-media.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Types of physical transmission media.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/twisted-pair-cables.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Twisted-pair cables.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/coaxial-cables.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Coaxial cables.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/fibre-optic-cables.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Fibre-optic cables.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/classic-ethernet.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/10-base-2-ethernet.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Thin Ethernet (10 Base-2).}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/shared-bus.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Shared bus in bus network topology.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/shared-bus-collision.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Collision on a shared bus.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/switched-ethernet.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/star-network-topology.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Star network topology in switched ethernet.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/ethernet-evolution-timeline.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Ethernet evolution timeline.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{7cm}]{images/chapter-20/mac-address-sticker.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{MAC address sticker.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/mac-address-contents.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{MAC address contents.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/ethernet-frame.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/ethernet-frame-physical-layer.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Ethernet frame - physical layer.}
	\end{minipage}}
\end{figure}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{15cm}]{images/chapter-20/ethernet-frame-data-link-layer.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Ethernet frame - data link layer.}
	\end{minipage}}
\end{figure}
