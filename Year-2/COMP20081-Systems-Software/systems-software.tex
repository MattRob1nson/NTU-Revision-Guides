...
As shown in the figure above, an IPv4 addresses:
\begin{itemize}
	\item containing all zeros (\texttt{0}s) identifies the host of origin;
	\item containing all ones (\texttt{1}s) allows broadcasting on the local network (i.e. "send to all neighbours");
	\item beginning with \texttt{127} are reserved for loopback (i.e. send from node to itself), often used for network testing;
	\item with a network ID containing all zeros (\texttt{0}s) identifies a host; and
	\item with a host ID containing all ones (\texttt{1}s) allows broadcasts on a distant network.
\end{itemize}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			...
			\begin{aligned}
				...
				& \text{starts with a 0} \\
				& \therefore \text{00000001 00001011 00001011 11101111 has class A} \\
				& \therefore \text{subnet mask} = \text{255.0.0.0} \\
				& \text{subnet mask} = \text{11111111 00000000 00000000 00000000} \\
			\end{aligned}
			\end{equation*}
			\begin{longtabu} to \textwidth {X[1,l] X[0.1,l] X[0.1,l] X[6,l]}
			...
			\begin{equation*}
				\begin{aligned}
					& \text{network ID} = \text{00000001 00000000 00000000 00000000} \\
					& \text{network ID} = \text{1} \\
				\end{aligned}
			\end{equation*}
			\begin{longtabu} to \textwidth {X[0.8,l] X[0.1,l] X[0.1,l] X[6,l]}
			...
			\begin{equation*}
				\begin{aligned}
					& \text{host ID} = \text{00000000 00001011 00001011 11101111} \\
					& \text{host ID} = \text{11.11.239} \\
				\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\begin{equation*}
			\begin{aligned}
			& \text{10001001 10000010 00001011 11001111} \\
			& \text{starts with 10} \\
			& \therefore \text{10001001 10000010 00001011 11001111 has class B} \\
			& \therefore \text{subnet mask} = \text{255.255.0.0} \\
			& \text{subnet mask} = \text{11111111 11111111 00000000 00000000} \\
			\end{aligned}
			\end{equation*}
			\begin{longtabu} to \textwidth {X[1,l] X[0.1,l] X[0.1,l] X[6,l]}
			...
			\begin{equation*}
			\begin{aligned}
			& \text{network ID} = \text{10001001 10000010 00000000 00000000} \\
			& \text{network ID} = \text{137.130} \\
			\end{aligned}
			\end{equation*}
			\begin{longtabu} to \textwidth {X[0.8,l] X[0.1,l] X[0.1,l] X[6,l]}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			...
			& \text{starts with 110} \\
			& \therefore \text{11000001 10000011 00011011 11111111 has class C} \\
			& \therefore \text{subnet mask} = \text{255.255.255.0} \\
			& \text{subnet mask} = \text{11111111 11111111 11111111 00000000} \\
			\end{aligned}
			\end{equation*}
			...
			\begin{equation*}
			\begin{aligned}
			& \text{network ID} = \text{11000001 10000011 00011011 00000000} \\
			& \text{network ID} = \text{193.131.27} \\
			\end{aligned}
			\end{equation*}
			\begin{longtabu} to \textwidth {X[1.2,l] X[0.1,l] X[0.1,l] X[6,l]}
			...
			\begin{equation*}
			\begin{aligned}
			& \text{host ID} = \text{00000000 00000000 00000000 11111111} \\
			& \text{host ID} = \text{255} \\
			\end{aligned}
			\end{equation*}
	\end{minipage}}
...
The number of subnets available can be calculated by:
\begin{equation*}
\text{subnets available} = 
\text{number of bits in extended network prefix} - \text{number of bits in network prefix in default subnet mask}
\end{equation*}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			...
			\begin{aligned}
			& \text{128.208.0.0/16} \\
			& \therefore \texttt{16 bits are used for the network prefix} \\
			& \therefore \texttt{subnet mask} = \text{255.255.0.0} \\
			\end{aligned}
			\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		\begin{equation*}
			\begin{aligned}
				& \text{198.208.80.0/24} \\
				& \therefore \texttt{24 bits are used for the network prefix} \\
				& \therefore \texttt{subnet mask} = \text{255.255.255.0} \\
			\end{aligned}
		\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
		\begin{equation*}
		\begin{aligned}
		& \text{given that the IP address 131.46.56.0 is class B} \\
		& \therefore \texttt{subnet mask} = \text{255.255.0.0} \\
		& \text{131.46.56.0} = \text{10000011 00101110 00111000 00000000}
		\\
		& \therefore \texttt{CIDR} = \text{131.45.56.0/16} \\
		& \\
		& \\
		& \text{given now that the subnet mask is 255.255.128.0, determine the CIDR} \\
		& \text{255.255.128.0} = \text{11111111 11111111 10000000 00000000} 
		\end{aligned}
		\end{equation*}
		\begin{longtabu} to \textwidth {X[1,l] X[0.1,l] X[0.1,l] X[6,l]}
			Network ID & = & & 10000011 00101110 00111000 00000000
			\\
		...
		\begin{equation*}
		\begin{aligned}
		& \text{network ID} = \text{10000011 00101110 00000000 00000000} \\
		& \text{network ID} = \text{131.46} \\
		\end{aligned}
		\end{equation*}
		\begin{longtabu} to \textwidth {X[0.8,l] X[0.1,l] X[0.1,l] X[6,l]}
			Host ID & = & & 10000011 00101110 00111000 00000000
			\\
			&   & \& & 00000000 00000000 01111111 11111111
			\\
			& & & -------------------------------------------------------
			\\
			&   & = & 00000000 00000000 00111000 00000000
		\end{longtabu}
		\begin{equation*}
		\begin{aligned}
		& \text{host ID} = \text{00000000 00000000 00111000 00000000} \\
		& \text{host ID} = \text{56.0} \\
		& \\
		& \text{the subnet mask 11111111 11111111 10000000 00000000 shows that 17 bits are used} \\ & \text{for the extended network prefix} \\
		& \therefore \text{CIDR} = \text{131.46.56.0/17} \\
		& \therefore \text{subnets available} = 2^{17-16} \\
		& \therefore \text{subnets available} = 2^{1} \\
		& \therefore \text{subnets available} = 2 \\
		\end{aligned}
		\end{equation*}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
