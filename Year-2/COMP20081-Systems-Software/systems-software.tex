...
The \textbf{application layer} uses protocols to format the data in a way which allows it to be used by the receiving application. This is the fifth layer in the TCP/IP stack.
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{7cm}]{images/chapter-16/domain-name-structure.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
