...
A \textbf{page table} is responsible for mapping virtual pages in to page frames.
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Logical program address.}
  \end{minipage}}
\end{figure}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Using the value at \texttt{4} as the base (\texttt{b}).}
  \end{minipage}}
\end{figure}
...
\begin{figure}[H]
  ...
  \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
    \abovecaptionskip=0pt
    \caption{Using the displacement value to complete the physical memory address.}
  \end{minipage}}
\end{figure}
...
\begin{equation*}
	\begin{aligned}
		\text{physical memory address} & = \text{page table value at index p} + \text{displacement value} \\
