...
\begin{longtabu} to \textwidth {| X[0.25,l] | X[1,l] | X[2,l] |}
	\hline
	\textbf{Class} & \textbf{Maximum number of networks} & \textbf{Maximum number of hosts}
	\\ \hline
	\texttt{A} & 128 & 16 million
	\\ \hline
	\texttt{B} & 16,384 & 65536
	\\ \hline
	\texttt{C} & 2 million & 256
	\\ \hline
\end{longtabu}

Class \texttt{D} is not defined as it is reserved for multicasting (a multicast is group communication where data transmission is addressed to a group of destination computers simultaneously).
