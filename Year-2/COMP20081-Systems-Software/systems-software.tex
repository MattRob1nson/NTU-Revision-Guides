...
The subnets can then be defined by exhausting all possible combinations of the additional bits in the extended network prefix until the required amount of subnets is reached (in this case, three subnets):
