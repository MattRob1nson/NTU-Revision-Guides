...
The \texttt{java.net} package API provides the \texttt{serversocket} and \texttt{socket} clesses.
...
\begin{figure}[H]
	...
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\centering
			\includegraphics[max size={\textwidth}{20cm}]{images/chapter-13/server-client-setup.png}
	\end{minipage}}
	\fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
			\abovecaptionskip=0pt
			\caption{Server and client set up.}
	\end{minipage}}
\end{figure}
...
\begin{lstlisting}[title={TimeServer.}]
import java.net.*;
import java.util.*;
import java.io.*;
...
\begin{lstlisting}[title={TimeClient.}]
import java.net.*;
import java.uo.*;
...
The \texttt{java.net} package API provides the \texttt{datagramsocket} and \texttt{datagrampacket} clesses.
